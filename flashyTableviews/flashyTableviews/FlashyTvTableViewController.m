...
@property (strong, nonatomic) NSArray *flashyNames;
...
- (void)viewDidLoad {
    ...
    self.flashyNames = @[@"Cenker",@"Helen", @"Feyhan",@"Recep",@"Ozlem",@"Demir", @"Baris"];
    
    [self.tableView addParallaxWithImage:[UIImage imageNamed:@"bentley.jpg"] andHeight:180.0];
